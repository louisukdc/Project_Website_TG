        ...
        <div class="content">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="kode" id="exampleFormControlInput1" placeholder="Kode Matakuliah">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Nama Matakuliah</label>
                                    <input type="text" class="form-control" name="matkul" id="exampleFormControlInput1" placeholder="Nama Matakuliah">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Semester</label>
                                    <input type="text" class="form-control" name="semester" id="exampleFormControlInput1" placeholder="Semester">
                                </div>
            ...
            <table class="table table-bordered text-center float-start">
                ...
                <tbody>
                    ...
                    $Read_MataKuliah = query("SELECT * FROM t_matakuliah");
                    $tampil = mysqli_query($con, $sql);
                    if (mysqli_num_rows($tampil) == 0) {
                        echo "<tr><td colspan='7'>Tidak ada data yang tersedia.</td></tr>";
                    } else {
                        foreach ($Read_MataKuliah as $row) : ?>
                            <tr>
                                <th><?= $i; ?></th>
                                <td><?= $row['MataKuliah_ID']; ?></td>
                                <td><?= $row['NamaMataKuliah']; ?></td>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="" method="post">
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    <label for="exampleFormControlInput1" class="form-label">Kode Matakuliah</label>
                                                    <input type="text" class="form-control" name="kode" id="exampleFormControlInput1" placeholder="Kode Matakuliah" value="<?= $row['MataKuliah_ID']; ?>" readonly>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="exampleFormControlInput1" class="form-label">Nama Matakuliah</label>
                                                    <input type="text" class="form-control" name="matkul" id="exampleFormControlInput1" placeholder="Nama Matakuliah" value="<?= $row['NamaMataKuliah']; ?>">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="exampleFormControlInput1" class="form-label">Semester</label>
                                                    <input type="text" class="form-control" name="semester" id="exampleFormControlInput1" placeholder="Semester" value="<?= $row['Semester']; ?>">
                                                </div>
                                        ...
                                        <form action="" method="post">
                                            <div class="modal-body">
                                                <h5 class="text-center">Apakah Anda Yakin Akan Menghapus Data Ini ? <br>
                                                    <span class="text-danger"><?= $row['MataKuliah_ID'] ?> - <?= $row['NamaMataKuliah'] ?></span>
                                                </h5>
                                            </div>
                                            <div class="modal-footer">
